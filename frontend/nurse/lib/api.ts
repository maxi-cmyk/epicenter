...
import type { ActionResult, AuditRecord, DashboardSnapshot, PatientCreateRequest, PatientDeleteRequest, PatientList, PatientRecord, PatientUpdateRequest, ReadinessState } from "@epicenter/shared/contracts";
