...
export const demoSnapshot: DashboardSnapshot = {
  ...
  tickets: [
    ...
    { id: "Q-017", patient_id: "P-0442", patient_name: "Mei Chen", intake_type: "walk_in", visit_phase: "ongoing", readiness_state: "processing", readiness_reason: "processing", checked_in_at: "2026-08-12T09:34:00Z", original_ordering_at: "2026-08-12T09:34:00Z", waiting_minutes: 8, actual_counter: "1", processing_stage: "Document extraction", service_target: "on_track", staff_confirmed: false, clinical_escalation: false, version: 1 },
    { id: "Q-018", patient_id: "P-0451", patient_name: "Amir Loh", intake_type: "walk_in", visit_phase: "ongoing", readiness_state: "needs_review", readiness_reason: "expired_document", checked_in_at: "2026-08-12T09:24:00Z", original_ordering_at: "2026-08-12T09:24:00Z", waiting_minutes: 18, actual_counter: "2", processing_stage: "Voucher review", service_target: "approaching", staff_confirmed: false, clinical_escalation: false, version: 1 },
    { id: "Q-019", patient_id: "P-0458", patient_name: "Priya Nair", intake_type: "walk_in", visit_phase: "ongoing", readiness_state: "ready", readiness_reason: "all_prerequisites_passed", checked_in_at: "2026-08-12T09:37:00Z", original_ordering_at: "2026-08-12T09:37:00Z", waiting_minutes: 5, actual_counter: "3", processing_stage: "Waiting to be called", service_target: "on_track", staff_confirmed: true, clinical_escalation: false, version: 1 },
