...
export const demoSnapshot: DashboardSnapshot = {
  ...
  tickets: [
    ...
    { id: "Q-020", patient_id: "P-0463", patient_name: "Marcus Lim", intake_type: "walk_in", visit_phase: "ongoing", readiness_state: "ready", readiness_reason: "all_prerequisites_passed", checked_in_at: "2026-08-12T09:20:00Z", original_ordering_at: "2026-08-12T09:20:00Z", waiting_minutes: 22, actual_room: "Room 2 · Dr Farah", processing_stage: "Consultation in progress", service_target: "on_track", staff_confirmed: true, clinical_escalation: false, version: 1, matched_package: "TPA-GP01 — GP Consultation", package_confirmed: false, billing_code: "TPA-GP01", uncovered_cost: 0, queue_number: "Q020", billing_confirmed: false, record_checklist: { patient: { full_name: "Marcus Lim", identifier_masked: "S***463B", date_of_birth: "1985-04-02", contact_mobile: "9**2 640", address: "30 Northshore Drive" }, items: [
