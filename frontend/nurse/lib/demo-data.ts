...
export const demoSnapshot: DashboardSnapshot = {
  ...
  tickets: [
    { id: "Q-014", patient_id: "P-0417", patient_name: "Loh Wei Ming", intake_type: "booked", visit_phase: "incoming", readiness_state: "needs_review", readiness_reason: "ambiguous_match", scheduled_at: "2026-08-12T10:00:00Z", original_ordering_at: "2026-08-12T10:00:00Z", waiting_minutes: 0, expected_room: "S2", processing_stage: "Insurance eligibility review", service_target: "approaching", staff_confirmed: false, clinical_escalation: false, version: 1, matched_package: "WELL2 — Comprehensive Screen", package_confirmed: false, billing_code: "WELL2-STD", uncovered_cost: 0, queue_number: "Q014", billing_confirmed: false, identity_confirmed: false, ecard_verified: false, ecard_not_applicable: false, forms_confirmed: false, physical_forms_received: false, is_checkup: true, documents: [], record_checklist: { patient: { full_name: "Loh Wei Ming", identifier_masked: "S***946C", date_of_birth: "1988-03-15", contact_mobile: "9**1 234", address: "12 Function Place" }, items: [
      { label: "Patient details", status: "pass", detail: "S***946C" },
      { label: "Coverage document", status: "pass", detail: "Meridian (MRDEB) · referral letter" },
      { label: "Eligibility match", status: "pending", detail: "WELL2 booked · Meridian referral on file" },
    ...
    { id: "Q-017", patient_id: "P-0442", patient_name: "Mei Chen", intake_type: "walk_in", visit_phase: "ongoing", readiness_state: "processing", readiness_reason: "processing", checked_in_at: "2026-08-12T09:34:00Z", original_ordering_at: "2026-08-12T09:34:00Z", waiting_minutes: 8, actual_room: "S2", processing_stage: "Document extraction", service_target: "on_track", staff_confirmed: false, clinical_escalation: false, version: 1, package_confirmed: false, billing_confirmed: false, identity_confirmed: false, ecard_verified: false, ecard_not_applicable: false, forms_confirmed: false, physical_forms_received: false, is_checkup: false, documents: [], record_checklist: { patient: { full_name: "Mei Chen", identifier_masked: "S***442F", date_of_birth: "1995-11-20", contact_mobile: "9**7 108", address: "4 Riverwalk Avenue" }, items: [
    ...
    { id: "Q-018", patient_id: "P-0451", patient_name: "Amir Loh", intake_type: "walk_in", visit_phase: "ongoing", readiness_state: "needs_review", readiness_reason: "expired_document", checked_in_at: "2026-08-12T09:24:00Z", original_ordering_at: "2026-08-12T09:24:00Z", waiting_minutes: 18, actual_room: "S3", processing_stage: "Voucher review", service_target: "approaching", staff_confirmed: false, clinical_escalation: false, version: 1, matched_package: "Executive screening", package_confirmed: false, billing_code: "EXEC-STD", uncovered_cost: 45, queue_number: "Q018", billing_confirmed: false, identity_confirmed: false, ecard_verified: false, ecard_not_applicable: false, forms_confirmed: false, physical_forms_received: false, is_checkup: false, documents: [], record_checklist: { patient: { full_name: "Amir Loh", identifier_masked: "S***451A", date_of_birth: "1983-01-09", contact_mobile: "9**3 671", address: "21 Bluepeak Lane" }, items: [
    ...
    { id: "Q-019", patient_id: "P-0458", patient_name: "Priya Nair", intake_type: "walk_in", visit_phase: "ongoing", readiness_state: "ready", readiness_reason: "all_prerequisites_passed", checked_in_at: "2026-08-12T09:37:00Z", original_ordering_at: "2026-08-12T09:37:00Z", waiting_minutes: 5, actual_room: "S4", processing_stage: "Waiting to be called", service_target: "on_track", staff_confirmed: true, clinical_escalation: false, version: 1, matched_package: "PEE226 — Basic Screen", package_confirmed: false, billing_code: "PEE226-CHAS", uncovered_cost: 8.5, queue_number: "Q019", billing_confirmed: false, identity_confirmed: false, ecard_verified: false, ecard_not_applicable: false, forms_confirmed: false, physical_forms_received: false, is_checkup: false, documents: [], record_checklist: { patient: { full_name: "Priya Nair", identifier_masked: "S***458G", date_of_birth: "1990-05-30", contact_mobile: "8**9 214", address: "17 Coral Drive" }, items: [
    ...
    { id: "Q-020", patient_id: "P-0463", patient_name: "Marcus Lim", intake_type: "walk_in", visit_phase: "ongoing", readiness_state: "ready", readiness_reason: "all_prerequisites_passed", checked_in_at: "2026-08-12T09:20:00Z", original_ordering_at: "2026-08-12T09:20:00Z", waiting_minutes: 22, actual_room: "S1", processing_stage: "Consultation in progress", service_target: "on_track", staff_confirmed: true, clinical_escalation: false, version: 1, matched_package: "TPA-GP01 — GP Consultation", package_confirmed: false, billing_code: "TPA-GP01", uncovered_cost: 0, queue_number: "Q020", billing_confirmed: false, identity_confirmed: false, ecard_verified: false, ecard_not_applicable: false, forms_confirmed: false, physical_forms_received: false, is_checkup: false, record_checklist: { patient: { full_name: "Marcus Lim", identifier_masked: "S***463B", date_of_birth: "1985-04-02", contact_mobile: "9**2 640", address: "30 Northshore Drive" }, items: [
  ...
  review_cases: [
    { id: "R-014", ticket_id: "Q-014", patient_name: "Loh Wei Ming", reason_code: "ambiguous_match", reason_label: "Insurance eligibility needs confirmation", document_name: "Meridian_referral.pdf", evidence_summary: "WELL2 booked · Meridian referral letter on file — cover does not match automatically", waiting_minutes: 0, service_target: "approaching", next_action: "Confirm insurer cover at the slow counter" },
