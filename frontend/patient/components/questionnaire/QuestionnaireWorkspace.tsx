...
export function QuestionnaireWorkspace({
  ...
  const [editingSubmitted, setEditingSubmitted] = useState(initialEditing);
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      setEditingSubmitted(initialEditing);
    } catch (loadError) {
        ...
        {canEdit ? (
            ...
            <div>
              ...
              {showingReview ? (
                <Button disabled={saving || !acknowledged} onClick={() => void submitFromReview()}>
                  {saving ? "Submitting…" : form.status === "submitted" ? "Save changes" : "Submit questionnaire"}
                </Button>
          ...
          <div className={styles.successBox} role="status">
            ...
            <div className={styles.uploadActions}>
              <Button onClick={() => setEditingSubmitted(true)} variant="secondary">
                Edit answers
              </Button>
