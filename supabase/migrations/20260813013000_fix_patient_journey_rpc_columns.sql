-- Fix patient journey RPCs to use appointment_questionnaire_responses.appointment_id.
begin;
...
begin
  ...
  select coalesce(jsonb_agg(visit_row order by visit_row.sort_at desc), '[]'::jsonb)
  into visits
  from (
